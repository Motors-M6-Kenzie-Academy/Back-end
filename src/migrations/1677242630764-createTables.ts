...
export class createTables1677242630764 implements MigrationInterface {
    name = 'createTables1677242630764'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "ads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(120) NOT NULL, "description" character varying(120) NOT NULL, "typeVehicle" character varying(10) NOT NULL, "typeAds" character varying NOT NULL DEFAULT 'sell', "releaseYear" character varying(50) NOT NULL, "mileage" character varying(50) NOT NULL, "price" character varying(50) NOT NULL, "cover" character varying(124) NOT NULL, "gallery_image" character varying(124) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_a7af7d1998037a97076f758fc23" PRIMARY KEY ("id"))`);
